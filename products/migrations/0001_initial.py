    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=254)),
                ('universe', models.CharField(blank=True, max_length=254)),
                ('author', models.CharField(blank=True, max_length=254)),
                ('artist', models.CharField(blank=True, max_length=254)),
                ('publishedby', models.CharField(blank=True, max_length=254)),
